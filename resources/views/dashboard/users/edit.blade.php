...
@section('title')
<title>@lang('site.dashboard') | @lang('site.user') | @lang('site.edit')</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"
                        ...
                        <li class="breadcrumb-item active p-0">@lang('site.edit_user')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('dashboard.user.update', $user)}}" method="post" class="allow-delete"
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group text-center m-0">
                                            <img src="{{$user->getPathImage()}}" alt="user image"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="postal_code"
                                                value="{{old('postal_code', $user->postal_code)}}" class="form-control">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" multiple name="permissions[]"
                                                ...
                                                <option value="{{$peremption . '_' . $model}}"
                                                    {{$user->isAbleTo($peremption . '_' . $model)? 'selected' : ''}}>
