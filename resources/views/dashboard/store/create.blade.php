...
@section('title')
<title>@lang('site.dashboard') | @lang('site.stores') | @lang('site.add_store')</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"
                        ...
                        <li class="breadcrumb-item active p-0">@lang('site.add_store')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('dashboard.store.store')}}" method="post" class="allow-delete"
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group text-center m-0">
                                            <img src="" alt="store image" class="img-thumbnail image-area"
