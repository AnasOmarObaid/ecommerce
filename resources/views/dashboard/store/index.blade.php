...
@section('title')
<title>@lang('site.dashboard') | @lang('site.stores') | @lang('site.index')</title>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"
                        ...
                        <li class="breadcrumb-item active"> @lang('site.stores')
                        </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                    ...
                    <div class="card  card-primary card-outline">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 my-auto">
                                        <input type="search" name="search" class="form-control"
                                            ...
                                            placeholder="@lang('site.search_place_store')">
                                    </div>{{-- end col --}}
                                    ...
                                    <div class="col-md-8 my-auto">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                {{-- create stores --}}
                                                @if (auth()->user()->isAbleTo('create_stores'))
                                                <a href="{{route('dashboard.store.create')}}"
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{$store->getImagePath()}}" style="height: 40px" width="40px"
                                                alt="store Image">
                                        </td>
                                        ...
                                        <td>{{$store->getProductCount()}}</td>

                                        <td>{{$store->rating}}</td>


                                        <td>{{$store->created_at->toFormattedDateString()}}</td>
                                        <td>

                                            {{-- edit btn --}}
                                            @if (auth()->user()->isAbleTo('update_stores'))
                                            <a class="btn btn-primary btn-sm mb-2"
                                                href="{{route('dashboard.store.edit', $store)}}"><i
                                            ...
                                            {{-- delete form --}}
                                            @if (auth()->user()->isAbleTo('delete_stores'))
                                            <form style="display: inline-block" class="delete_user_btn"
                                                data-url=" {{route('dashboard.store.destroy', $store)}}">
                                                @csrf
                                                @method('delete')
                            ...
                            <div class="alert alert-dark" role="alert">
                                ...
                                <p>@lang('site.no_store_info') <a class="badge badge-primary"
                                        style="text-decoration: none"
                                        href="{{route('dashboard.store.create')}}">@lang('site.click_me')</a>
                                </p>
                                <hr>
