...
@section('title')
<title>@lang('site.dashboard') | @lang('site.categories') | @lang('site.edit_category')</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"
                        ...
                        <li class="breadcrumb-item active p-0">@lang('site.edit_category')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('dashboard.category.update', $category)}}" method="post" class="allow-delete"
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group text-center m-0">
                                            <img src="{{$category->getImagePath()}}" alt="category image"
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn btn-success"><i class="fa fa-plus fa-fw"></i>
                                    @lang('site.edit_category')</button>
