...
@section('title')
<title>@lang('site.dashboard') | @lang('site.products') | @lang('site.edit_products')</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right"
                        ...
                        <li class="breadcrumb-item active p-0">@lang('site.edit_products')</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <form action="{{route('dashboard.product.update', $product)}}" method="post" class="allow-delete"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" class="form-control select2">
                                                ...
                                                <option value="{{$category->id}}" @if (request('category_id'))
                                                    {{request('category_id') == $category->id ? 'selected' : ''}} @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="{{$locale}}[description]" cols="50" class="form-control"
                                                rows="5">{{old($locale . '.description', $product->translate($locale)->description)}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group text-center m-0">
                                            <img src="{{$product->getPoster()}}" alt="poster image"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small>@lang('site.note_image')</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="10000000" name="stoke" name="stoke"
                                                value="{{old('stoke', $product->stoke)}}" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="1000000" name="curet_sale_price"
                                                value="{{old('curet_sale_price', $product->curet_sale_price)}}"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="1000000" name="new_sale_price"
                                                value="{{old('new_sale_price', $product->new_sale_price)}}"
                                                value="{{old('new_sale_price')}}" class="form-control">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" class="select2 form-control">
                                                        <option value=""></option>
                                                        <option value="1" @if (request('gender'))
                                                            {{old('gender') == 1 ? 'selected' : ''}} @else
                                                            {{$product->gender == 1 ? 'selected' : ''}} @endif>
                                                            @lang('site.male')</option>
                                                        <option value="0" @if (request('gender'))
                                                            {{old('gender') == 0 ? 'selected' : ''}} @else
                                                            {{$product->gender === 0 ? 'selected' : ''}} @endif>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="sizes[]" class="form-control select2" multiple>
                                                        ...
                                                        <option value="{{$size->id}}" @foreach ($product->sizes as
                                                            $product_size)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="{{$locale}}[raw]" class="form-control"
                                                        value="{{old($locale . '.raw', $product->translate($locale)->raw)}}">
                                                    <small>@lang('site.optional')</small>
                                                </div>
                                                @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="colors[]" class="form-control select2" multiple>
                                                        ...
                                                        <option value="{{$color->id}}" @foreach ($product->colors as
                                                            $product_color)
                                                            {{$product_color->id == $color->id ? 'selected' : ''}}
                                                            @endforeach>{{$color->color}}</option>
                                                        @endforeach
                                                    </select>
                                                    <small>@lang('site.optional')</small>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="{{$locale}}[tag]" class="custom_tag form-control"
                                                        value="{{old($locale . '.tag',  $product->translate($locale)->tag)}}">
                                                    <small>@lang('site.optional')</small>
                                                </div>
                                                @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="{{$locale}}[pro_ins]" class="custom_tag form-control"
                                                        value="{{old($locale . '.pro_ins',  $product->translate($locale)->pro_ins)}}">
                                                    <small>@lang('site.optional')</small>
                                                </div>
                                                @endforeach
                                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn btn-success"><i class="fa fa-plus fa-fw"></i>
                                    @lang('site.edit_products')</button>
